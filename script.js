...
const init = () => {
        ...
        const $listaDeDispositivos = document.querySelector(".recorder .devices"),
            $duracion = document.querySelector(".recorder .timer"),
            $btnComenzarGrabacion = document.querySelector(".recorder .start"),
            $btnDetenerGrabacion = document.querySelector(".recorder .stop"),
            $player = document.querySelector(".player audio"),
            $input_file = document.querySelector(".player .audio-file");
                ...
                .then(
                    stream => {
                        ...
                        mediaRecorder.addEventListener("stop", () => {
                            ...
                            //const blobAudio = new File(fragmentosDeAudio, 'recorded-audio.webm');
                            ...
                            //$input_file.files.append(blobAudio);

                            //console.log($input_file);

                            $player.src = urlParaDescargar;
                            $player.load();
                            ...
                            /* send to server */
                              ...
                              formData.append('otros', "Otros datos");
                              formData.append('audio_file', blobAudio, 'audio_file.webm');
